...
* The Screen To PDF feature was removed since OutSystems changed their internal code making it impossible to intercept the navigation of the application and trigger the PDF generation.
